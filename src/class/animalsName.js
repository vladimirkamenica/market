    ...
    animals : [
        {
            ...
            Predstavljamo nekoliko desetina imena za krave koja su najčešća u našem jeziku i podneblju: 
            `,
            img : FindIcon.find('Krave za klanje').img,
            color : FindIcon.find('Krave za klanje').color,
            names: [
            ['Ana'],
            ['Belka', 'Belkica', 'Berta', 'Bojana', 'Bona', 'Brena'],
            ['Ceca', 'Cica', 'Crna', 'Cveta', 'Cvetanka', 'Cvetka', 'Cvetulja'],
            ['Dara', 'Dora', 'Drina'],
            ['Frida'],
            ['Gala', 'Gara', 'Garova'],
            ['Indira'],
            ...
            ['Lidija', 'Liza', 'Lozava'],
            ['Ljuba', 'Ljubova'],
            ['Maca', 'Mačkica', 'Maja', 'Maza', 'Mica', 'Mila', 'Milka', 'Milkica', 'Mira', 'Mrka', 'Mrkova'],
            ['Naca', 'Nata'],
            ['Petra', 'Petruša'],
            ['Ranka', 'Roza', 'Rozica', 'Rujka', 'Rumenka', 'Ruža', 'Ruška'],
            ['Sandra', 'Saška', 'Srna', 'Sofka', 'Sofija', 'Sonja', 'Siva'],
            ['Šarka', 'Šarulja'],
            ['Veca', 'Vera'],
            ['Zvezda', 'Zvezdana'],
            ['Željka'],
        ...
        },
        {
            ...
            names : [
                ['Belka', 'Belica', 'Biba', 'Bika', 'Blizna', 'Breza', 'Brna', 'Buba'],
                ['Ciga', 'Cigica', 'Cvitka', 'Cvetka', 'Crna'],
                ['Čađa', 'Čula'],
                ['Dika', 'Dunja'],
                ['Gala', 'Gara', 'Gizda'],
        ...
        },
        {
            ...
            names : [
                ['Aga', 'Arap', 'Atila'],
                ['Bećar', 'Bilac', 'Brnac', 'Brnja', 'Bugar'],
                ['Car', 'Cezar', 'Ciga', 'Crni', 'Cvetko', 'Cvitko'],
                ['Čilaš', 'Čilag'],
                ['Dečko', 'Despot', 'Dilber', 'Dorat', 'Doro', 'Dragan'],
                ['Đogo', 'Đogat'],
                ['Galin', 'Gavran', 'General', 'Golub'],
                ['Jadran', 'Jaran'],
                ['Kasač', 'Kazanova', 'King', 'Kulaš'],
                ['Lisac', 'Lisko', 'Lola', 'Lord'],
                ['Mađar', 'Malin', 'Moro', 'Mrka', 'Mrkalj', 'Mrkov', 'Munja', 'Musa'],
                ['Otoman'],
                ['Paša', 'Plavac', 'Puta', 'Putko'],
                ['Rićko', 'Riđi', 'Rubin'],
                ['Senator', 'Sivac', 'Sivi', 'Skopljan', 'Sokol', 'Sultan', 'Sura', 'Suri'],
                ['Šandor', 'Šarac', 'Šargo', 'Švarc'],
                ['Tatar'],
                ['Vitez', 'Vranac'],
                ['Zeka', 'Zekan', 'Zelenko', 'Zeus', 'Zlatko', 'Zoran'],
                ['Ždral', 'Žerav'],
            ]
        },
        {
