<template>
   <b-col cols="12" lg="6" md="6">
        <b-card class="mb-4 cardHeight">
          <h4 class="card-title">Cena stoke na pijacama - danas (u dinarima)</h4>     
...
export default {
    ...
    data(){
      return {   
          display: false,
          current_month: '',
          header: ['Čačak','Kragujevac','Kraljevo','Loznica','Sombor','Užice'],         
            data_filter : [] ,         
            weeks: [],
            find_week : [],
            ...
            data : [],
            datasetsBar: [],
            products :['Bikovi',"Jagnjad","Ovca","Prasad", "Krmače za klanje"],
            category : 3,
            type : 4,
      }
    },
    ...
    methods:{ 
       async displayData(){                    
         ...
         async getDataOfTable(){
           console.log(this.current_month[0])
